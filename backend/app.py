...
def export_report(session_id: str, format: str = "md"):
    ...
    if format == "md":
        ...
        try:
            ...
            story.append(Spacer(1, 6))
            story.append(Paragraph("Generated by ResearchMind AI · Groq Llama 3.3 70B · DuckDuckGo Live Search", meta_style))
        ...
        try:
            ...
            footer_run = footer_para.add_run("Generated by ResearchMind AI · Groq Llama 3.3 70B · DuckDuckGo Live Search")
